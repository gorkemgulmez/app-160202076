...
CREATE TABLE IF NOT EXISTS analyzes (id INTEGER PRIMARY KEY AUTOINCREMENT, patient_id INTEGER, doctor_id INTEGER, alaysis_name TEXT, description TEXT);
INSERT INTO analyzes (patient_id, doctor_id, analysis_name, description) VALUES ('1', '1', 'deneme', 'deneme');
